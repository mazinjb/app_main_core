...
Future<void> main() async {
  // تهيئة Flutter قبل كل شيء
  WidgetsFlutterBinding.ensureInitialized();

  // 1. تهيئة نظام الترجمة
  await AppTranslator.init(
    ...
    specificTranslations: {
      'en_US': {
        ...
        'card_example_title': 'Card Element Example',
        'card_example_content': 'Styles are applied automatically based on the current mode.',
        'username_label': 'Username',
        'password_label': 'Password',
        'login_button': 'Login',
        'theme_switcher_tooltip': 'Toggle Theme',
        'language': 'Language',
        'customize_button_color': 'Customize Button Color',
        'reset_color': 'Reset',
        'view_documentation': 'View Documentation',
        'copied_to_clipboard': 'Copied to clipboard!',
        'docs_readme': 'README',
        'docs_example': 'Example',
        'docs_installing': 'Installing',
        'gradient_button': 'Gradient Button', // ✅ إضافة مفتاح الترجمة
      },
      'ar_SA': {
        ...
        'welcome_message': 'مرحباً بك في تطبيقي',
        'card_example_title': 'مثال لعنصر الكارت',
        'card_example_content': 'يتم تطبيق الأنماط تلقائياً حسب الوضع الحالي.',
        'username_label': 'اسم المستخدم',
        'password_label': 'كلمة المرور',
        'login_button': 'تسجيل الدخول',
        'theme_switcher_tooltip': 'تغيير الثيم',
        'language': 'اللغة',
        'customize_button_color': 'تخصيص لون الزر',
        'reset_color': 'إعادة تعيين',
        'view_documentation': 'عرض التوثيق',
        'copied_to_clipboard': 'تم النسخ إلى الحافظة!',
        'docs_readme': 'الرئيسية',
        'docs_example': 'مثال',
        'docs_installing': 'التثبيت',
        'gradient_button': 'زر متدرج', // ✅ إضافة مفتاح الترجمة
      },
    },
  );

  // 2. تهيئة نظام الثيمات
  Get.put(AppTheme(
    ...
    return GetBuilder<AppTheme>(
      builder: (themeController) {
        return Obx(() => GetMaterialApp(
          ...
          home: const HomeScreen(), // استخدام الواجهة الرئيسية من ملفها الخاص
        ));
      },
    );
  }
