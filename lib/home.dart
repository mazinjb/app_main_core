    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            icon: Icon(
                controller.isDarkMode ? Icons.wb_sunny_outlined : Icons.nightlight_round),
          ...
          child: Column(
            ...
            children: [
                ...
                child: Card(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('card_example_title'.tr,
                            style: textTheme.headlineMedium),
                        const SizedBox(height: 8),
                        Text('card_example_content'.tr,
              ...
              AppMotion.list(
                ...
                fadeFrom: 0.0,
                enterFrom: AppMotionDirection.bottom,
                children: [
                  AppForm(
                    key: formKey,
                    textFields: const ['username', 'password'],
                    onSubmit: (data) {
                      Get.snackbar('login_success'.tr,
                      ...
                      return Column(
                        children: [
                          AppTextField(
                            ...
                            theme: const AppTextFieldThemeSettings(
                                type: AppTextFieldTheme.outlined),
                  ...
                  AppDropdown(
                    ...
                    style: const AppDropdownStyle(
                        type: AppDropdownType.searchable),
                    isRequired: true,
                  ),
                  const SizedBox(height: 16),
                  AppRadioButton(
                    ...
                    style: const AppRadioButtonStyle(
                        type: AppRadioButtonType.secondary),
                    isRequired: true,
                  ),
                  const SizedBox(height: 16),
                  AppCheckBox(
                    ...
                    style: AppCheckBoxStyle.fromType(
                        AppCheckBoxType.horizontal, context),
                  ),
                  ...
                  AppButton(
                    onPressed: () {},
                    text: 'gradient_button'.tr,
                    icon: Icons.star,
                    style: AppButtonStyle.primaryGradient(context),
                  ),
                ],
              ),
              const SizedBox(height: 24),
              ...
              Wrap(
                ...
                children: [
                  ...
                  AppButton(
                    onPressed: () =>
                        controller.updateLocale(const Locale('ar', 'SA')),
                    text: 'العربية',
                    style: AppButtonStyle.secondary(context),
                    type: AppButtonType.outlined,
                  ),
                  AppButton(
                    onPressed: () =>
                        controller.updateLocale(const Locale('fr', 'FR')),
                    text: 'Français',
                    style: AppButtonStyle.secondary(context),
                    type: AppButtonType.outlined,
                  ),
              ...
              const Divider(),
              const SizedBox(height: 16),
              Text('customize_button_color'.tr,
                  style: textTheme.headlineMedium, textAlign: TextAlign.center),
              const SizedBox(height: 16),
              Wrap(
                alignment: WrapAlignment.center,
                ...
                children: [
                  AppColorSwatch(
                      color: Colors.red,
                      onTap: () => controller.overrideButtonColor(Colors.red)),
                  AppColorSwatch(
                      color: Colors.green,
                      onTap: () =>
                          controller.overrideButtonColor(Colors.green)),
                  AppColorSwatch(
                      color: Colors.blue,
                      onTap: () => controller.overrideButtonColor(Colors.blue)),
                  AppButton(
      ...
      floatingActionButton: Obx(() {
        final fabBackgroundColor =
            controller.buttonColorOverride.value ??
                Theme.of(context).colorScheme.secondary;

        final fabIconColor =
        ThemeData.estimateBrightnessForColor(fabBackgroundColor) ==
            Brightness.dark
            ? Colors.white
            : Colors.black;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16), // ✅ إضافة مسافة

              // ✅  مثال على الزر ذي التدرج اللوني
              AppButton(
                onPressed: () {},
                text: 'gradient_button'.tr,
                icon: Icons.star,
